 ...
 * @return string
 */
function test_issue_13_file_exclude_1( $first_param, $second_param ) {
	/**
	 ...
	 * @param string $second_param This is the second argument.
	 */
	$some_variable = apply_filters( 'test_issue_13_file_exclude_1', $first_param, $second_param );
 ...
 * @return string
 */
function test_issue_13_file_exclude_2( $first_param, $second_param ) {
	/**
