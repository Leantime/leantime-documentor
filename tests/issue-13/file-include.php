 ...
 * @return string
 */
function test_issue_13_file_include_1( $first_param, $second_param ) {
	/**
	 ...
	 * @param string $second_param This is the second argument.
	 */
	$some_variable = apply_filters( 'test_issue_13_file_include_1', $first_param, $second_param );
 ...
 * @return string
 */
function test_issue_13_file_include_2( $first_param, $second_param ) {
	/**
	 ...
	 * @param string $second_param This is the second argument.
	 */
	return apply_filters( 'test_issue_13_file_include_2', $first_param, $second_param );
}
